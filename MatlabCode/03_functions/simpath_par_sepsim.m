function [sim_path,sim_sol] = simpath_par_sepsim(calib,var,data,paramhat,draws)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Simulation of life cycle paths - Invol. Separations %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% Prepare Random Components (use generated randoms)
        ...
        for z = 1:Z
            ...
            drandom4(:,:,z)     = random4((z-1)*R/Z+1:z*R/Z,:);
...
%for z = 1:Z
    ...
    random2     = drandom2(:,:,z);
    random3     = drandom3(:,:,z);
    random4     = drandom4(:,:,z);          % invol. separations
    ...
    [sim_path] = parsim_sepsim(calib,var,data,paramhat,sim_sol,random1,random2,random3,random_ed,WShock1_path,WShock2_path,MError,wdgrid1,wdgrid2,Educ_b,random4);
    ...
    pSepShock_path(:,:,z) = sim_path.SepShock_path;
...
for z = 1:Z
    if z == 1
        ...
        SepShock_path = pSepShock_path(:,:,z);
        ...
        SepShock_path = [SepShock_path;pSepShock_path(:,:,z)];
    end
