function [sim_path] = parsim_sepsim(calib,var,data,paramhat,sim_sol,random1,random2,random3,random_ed,WShock1_path,WShock2_path,MError,wdgrid1,wdgrid2,Educ_b,random4) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Parallelized simulation of life-cycle paths - Invol. Separations %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% Define Path Arrays
    ...
    SepShock_path = zeros(R/Z,T+1);           % involuntary separation indicator
...
%  ---------------------------------------------------------    
  ...
  % -----------------------------------------------------------
            ...
            if Reti_path(r,t) == 1
                ...
                %%% Simulate Involuntary Job Separations
                    % > set separations probability to (0,1) conditional on
                    %       shock realization
                    %  - just re-setting separations probabilities allows to
                    %       keep the derivation procedures below
                if Empl_path(r,t) == 2
    ...
    SepShock_path = [SepShock_path               zeros(R/Z,100-(T+20)+1)];
    ...
    sim_path = v2struct(C_path,Y_path,GCI_path,ITAX_path,CTAX_path,SSC_path,UINS_path,PINS_path, ...
                       ...
                       Wealth_path,Sav_path,Exper_path,Pov_path,Fav_path,SavChoice_path,ExpRatio_path,SepShock_path);
